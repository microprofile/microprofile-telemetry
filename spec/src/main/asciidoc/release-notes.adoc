...
[[release_notes_22]]
=== Release Notes for MicroProfile Telemetry 2.2
A full list of changes delivered in the 2.2 release can be found at link:https://github.com/eclipse/microprofile-telemetry/milestone/3?closed=1[MicroProfile Telemetry 2.2 Milestone].

==== Incompatible Changes
None.

==== API/SPI Changes
* Consume the latest OTel artifacts (https://github.com/eclipse/microprofile-telemetry/issues/318[318])

** Consume the OpenTelemetry Java release link:https://github.com/open-telemetry/opentelemetry-java/releases/tag/v1.64.0[v1.64.0]. The full comparison with the link:https://github.com/open-telemetry/opentelemetry-java/releases/tag/v1.49.0[v1.49.0] supported by MicroProfile Telemetry 2.1 can be found link:https://github.com/open-telemetry/opentelemetry-java/compare/v1.49.0...v1.64.0[here].

* Support code.* attributes in the `@WithSpan` annotation (https://github.com/eclipse/microprofile-telemetry/issues/321[321])
